...
db.advisories.insertMany([
  ...
  },
  {
    ...
    eventType: "Animal Sighting",
    details:
      "Sasquatch possibly sighted at the edge of forest. Proceed with caution",
  },
  {
    ...
    eventType: "Swimming",
    details:
      "Recent volcanic activity created highly acidic carbonic waters that will melt skin off the bone",
  },
  {
    latitude: 49.2039286,
  ...
  },
  {
    ...
    eventType: "Animal Sighting",
    details:
      "Large gathering of poisonous red jellyfish seen off coast of beach.",
  },
  {
  ...
  },
  {
    ...
    eventType: "Drinking Water",
    details:
      "700 barrels of wine has crashed into water supply, contaminating local drinking water",
  },
  {
    ...
    eventType: "Animal Sighting",
    details:
      "Red Ants and Black Ants have ended their thousand-year war and are combining forces, the hills are really big",
  },
  {
    ...
    eventType: "Swimming",
    details:
      "Active landslide has caused river to flow into lake, creating currents and unclear water",
  },
  {
    ...
    eventType: "Drinking Water",
    details:
      "Lead from concrete pipes seeping into water, boiling won't help, use bottled water for consumption.",
  },
  {
  ...
  },
  {
    ...
    eventType: "Swimming",
    details:
      "A recent fissure in lake ground has caused a massive whirlpool that is pulling debris and living things into the unknown. Bring a floaty.",
  },
  {
    ...
    eventType: "Drinking Water",
    details:
      "Kool-Aid Man has taken over nearby reservoir, the water is red but it's fine to drink. Oh Yeah!",
  },
  {
  ...
  },
  {
    ...
    eventType: "Drinking Water",
    details:
      "Tea bags have been prepped in the mugs. Don't forget to add honey!",
  },
  {
  ...
  {
    latitude: 48.52973926317433,
    longitude: -123.39506426460531,
    submissionTime: new Date(2024, 9, 19, 13, 13, 41),
    expirationTime: new Date(2024, 9, 21, 0, 0, 0),
    eventType: "Swimming",
    details:
      "Lost merfolk are battling a local lake serpent - swimming is NOT advised. Making wagers on who will win is encouraged",
  },
]);
